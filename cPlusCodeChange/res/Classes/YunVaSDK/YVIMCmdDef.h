...
namespace x11002{
	enum{
		/*string*/	 tt					= 1, //cp登录凭证，json字符串，可包含uid（必须,不能超过45个字符）、nickname、iconUrl、level、vip、ext、sex字段
...
namespace x11003 {
	enum {
		...
		/*string*/ thirdUserId		= 6, //第三方用户ID，uid
...
namespace x16002{
	enum{
		/*string*/	textMsg	 = 1, //发送内容，不超过384个字符
		/*string*/	wildCard = 2, //通配符
...
namespace x16016 {
	enum {
		/*uint32*/  time              = 1,	//时间间隔，单位：秒;默认为0（即没限制）
	};
}
...
namespace x19023{
	...
	{
		/*string*/      text            = 1,
		/*uint8*/		targetType		= 2,	//3 情感男声，4 情感女声
...
namespace x19025{
    enum{
        /*uint32*/        targetType        = 1,    //0 普通页面，1 web页面
    };
}
