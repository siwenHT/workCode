...
typedef enum
{
	...
	YvErrorCodeChatTextMaxNum       =  1005,    //More than the maximum length(>1024bit)
	YvErrorCodeChatNotLogin         =  1006,    //Not logged in chat room
	YvErrorCodeChatSendTooFrequently=  1007,    //Send message too frequently in chat room
	YvErrorCodeChatWildCardInvalid  =  1008,    //Send message with invalid wildcard in chat room
	...
	YvErrorCodeLoginStrlenMax       =  1104,    //login uid too long
	YvErrorCodeLoginisfail          =  1105,    //islogin fail
	YvErrorCodeLoginInvaildUid      =  1106,    //invaild uid
	...
	YvErrorCodeReocrdFrequently      = 1908,     //Reocrd too frequently
	YvErrorCodeReocrdTooShort		 = 1909,     //Reocrd too short
	...
	YvErrorCodePlayFileTypeError	  = 1924,	//play file type error
    YvErrorCodePlayDecodeMp3Error     = 1925,    //Decode Mp3 error
	YvErrorCodePlayParameterNull = 1926,   //PlayParameterNull
	...
	yvErrorCodeCaputreInitFail      =  1971,    //screen or camera open fail
	yvErrorCodeSetImageUploadFail   =  1972,    //set roomicon or set anchoricon 
