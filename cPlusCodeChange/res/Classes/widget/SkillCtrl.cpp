...
void SkillCtrl::createChain()
{
	...
	for(int i=0; i<=8; i++)
	{
		...
		int tmpSymbolKeyA[] = {}; //"res/mainui/skill.png"
		std::string keyA = HandleString(tmpSymbolKeyA, STRNUMSIG);	
	...
	int tmpSymbolKeyB[] = {}; //"res/mainui/ptgj.png"
	std::string keyB = HandleString(tmpSymbolKeyB, STRNUMSIG);	
	...
	int tmpSymbolKeyC[] = {}; //"res/mainui/cg.png"
	std::string keyC = HandleString(tmpSymbolKeyC, STRNUMSIG);	
	...
	int tmpSymbolKeyD[] = {}; //"toucheffect"
	std::string keyD = HandleString(tmpSymbolKeyD, STRNUMSIG);	
