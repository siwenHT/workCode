#ifndef __sensibleApplication_H__
#define __sensibleApplication_H__
#include "Ycommon.h"
#include "cocos2d.h"
NS_YOUNG_BEGIN
class sensibleApplication : public cocos2d::Node
{
public:
    sensibleApplication() {}
    virtual ~sensibleApplication() {}
    static sensibleApplication *create()
	{
	    sensibleApplication *pRet = new sensibleApplication();
	    if ( pRet && pRet->init() )
	    {
	        pRet->autorelease();
	        return pRet;
