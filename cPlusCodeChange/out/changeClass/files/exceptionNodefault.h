...
#include "cocos2d.h"
USING_NS_CC;
class exceptionNodefault : public Sprite
{
public :
	exceptionNodefault();
	~exceptionNodefault();
	virtual bool init(SpriteFrame* frame); 
	static exceptionNodefault* create(SpriteFrame* frame);
protected :
	void endMove();
	CC_SYNTHESIZE_READONLY(bool, m_incrementallyProvide, nodefaultCloses);
public:
