...
#include "JIGInterchangeablyUnderEffect.h"
...
void TouchSprite::onTouchDown(){
	JIGInterchangeablyUnderEffect jiginterchangeablyundereffect_e;
	jiginterchangeablyundereffect_e.indeedPositionedConcludes(nullptr,598,270,314);
